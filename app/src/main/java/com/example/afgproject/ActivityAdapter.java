...
public class ActivityAdapter extends RecyclerView.Adapter<ActivityHolder>{
    ...
    public ActivityAdapter(ArrayList<ActivityData> data, HolderType holderType) {
        this.data = data;
    ...
    public ActivityAdapter(ArrayList<ActivityData> data, HolderType holderType, MyAdapter.OnItemClickListener onItemClickListener) {
        this.data = data;
        this.context = context;
        this.holderType = holderType;
        this.onItemClickListener = onItemClickListener;
